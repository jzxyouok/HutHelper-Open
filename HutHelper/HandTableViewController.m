...
-(NSString*)getPhoto:(int)i{
    ...
    NSString *Url=[NSString stringWithFormat:@"http://hut.wxz.name:8888/%@",photo];
    return Url;
}
-(UIImage*)getImg:(int)i{
        NSString *Url=[NSString stringWithFormat:@"http://hut.wxz.name:8888/%@",[_Hand_content[i] objectForKey:@"image"]];
